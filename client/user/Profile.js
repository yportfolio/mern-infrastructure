...
export default function Profile({ match }) {
  ...
  if the user's id and the jwt do not match
  ...
  */
  ...
  /*   
  Check if the user of current profile has be followed by the signin user
  */
  ...
  /*  
  Every click, set the opposite value of following
  */
